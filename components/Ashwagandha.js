  ...
  return (
    ...
    >
      ...
      <Animatable.Image
        ...
        duration={1500}
        source={require("../assets/Ashwagandha.png")}
      ...
      <Animatable.View animation="fadeInUp" delay={700} style={styles.infoBox}>
        ...
        <View style={styles.point}>
          <Ionicons name="checkmark-circle-outline" size={20} color="#2E7D32" />
          <Text style={styles.infoText}>Boosts energy and stamina</Text>
        </View>

        <Text style={styles.infoHeading}>Uses:</Text>
        <View style={styles.point}>
          <Ionicons name="leaf-outline" size={20} color="#2E7D32" />
          <Text style={styles.infoText}>Used in Ayurveda powders and teas</Text>
        </View>
        <View style={styles.point}>
          <Ionicons name="leaf-outline" size={20} color="#2E7D32" />
          <Text style={styles.infoText}>
            Available in capsules and supplements
          </Text>
        </View>
        ...
        <View style={styles.point}>
          ...
          />
          <Text style={styles.infoText}>
            Roots and leaves are medicinally useful
          </Text>
        </View>
      </Animatable.View>
