...
const ExploreAllPlants = ({ navigation }) => {
  return (
    <ScrollView
    ...
    >
      {/* Page Heading */}
      <Animatable.Text animation="fadeInDown" delay={300} style={styles.heading}>
...
export default ExploreAllPlants;

const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#F0FFF4" },
  heading: { fontSize: 24, fontWeight: "bold", color: "#2E7D32", marginBottom: 20, textAlign: "center" },
  card: {
    flexDirection: "row",
    backgroundColor: "#fff",
    width: "90%",
  ...
  viewButton: { backgroundColor: "#388E3C", paddingVertical: 6, paddingHorizontal: 12, borderRadius: 8 },
  ...
  backButtonText: { color: "#fff", fontWeight: "bold", marginLeft: 8, fontSize: 16 },
});
