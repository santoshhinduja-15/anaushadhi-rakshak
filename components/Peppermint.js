  ...
  return (
    ...
    >
      <Animatable.Image
        ...
        duration={1500}
        source={require("../assets/Peppermint.png")}
      ...
      <Animatable.View animation="fadeInUp" delay={700} style={styles.infoBox}>
        ...
        <View style={styles.point}>
          ...
          <Text style={styles.infoText}>Aids digestion & relieves nausea</Text>
        </View>
        <View style={styles.point}>
          <Ionicons name="checkmark-circle-outline" size={20} color="#2E7D32" />
          <Text style={styles.infoText}>Relieves headaches</Text>
        </View>
        <View style={styles.point}>
          <Ionicons name="checkmark-circle-outline" size={20} color="#2E7D32" />
          <Text style={styles.infoText}>Refreshing & cooling effect</Text>
        </View>

        <Text style={styles.infoHeading}>Uses:</Text>
        <View style={styles.point}>
          <Ionicons name="leaf-outline" size={20} color="#2E7D32" />
          <Text style={styles.infoText}>Teas & beverages</Text>
        </View>
        <View style={styles.point}>
          <Ionicons name="leaf-outline" size={20} color="#2E7D32" />
        ...
        <View style={styles.point}>
          <Ionicons
            ...
            color="#2E7D32"
          />
          <Text style={styles.infoText}>Commonly used in aromatherapy</Text>
        </View>
        <View style={styles.point}>
          <Ionicons
            name="information-circle-outline"
            ...
            color="#2E7D32"
          />
          <Text style={styles.infoText}>Fast-growing perennial herb</Text>
        </View>
      </Animatable.View>
