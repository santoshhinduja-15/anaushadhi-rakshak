  ...
  return (
    ...
    >
      ...
      <Animatable.Image
        ...
        duration={1500}
        source={require("../assets/AloeVera.png")}
      ...
      <Animatable.View animation="fadeInUp" delay={700} style={styles.infoBox}>
        ...
        <View style={styles.point}>
          ...
          <Text style={styles.infoText}>
            Helps in skin care and burns healing
          </Text>
        </View>
        <View style={styles.point}>
          <Ionicons name="checkmark-circle-outline" size={20} color="#2E7D32" />
          <Text style={styles.infoText}>Improves digestion</Text>
        </View>

        <Text style={styles.infoHeading}>Uses:</Text>
        <View style={styles.point}>
          <Ionicons name="leaf-outline" size={20} color="#2E7D32" />
          <Text style={styles.infoText}>Used in cosmetics and gels</Text>
        </View>
        <View style={styles.point}>
          <Ionicons name="leaf-outline" size={20} color="#2E7D32" />
          <Text style={styles.infoText}>Drinks and home remedies</Text>
        </View>
